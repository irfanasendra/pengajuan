                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            Total Pengajuan</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= count_ajuan('surat_id') ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="collapse mt-2 mb-4" id="syarat<?=$row['idsurat'];?>">
                        <div class="card card-body">
                            <ol>
                                <p class="btn btn-danger">Wajib mengisi data pada data profil di menu profil sebelum melakukan pengajuan</p>
