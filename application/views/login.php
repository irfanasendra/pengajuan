...
<body class="bg-gradient-dark bg-gradient-light-1">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="<?=base_url('assets/img/diskominfo.png');?>" alt="Logo" width="400" height="400">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="<?=base_url('assets/img/formregister.jpg');?>" alt="Logo" width="450"
                                    height="400">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
