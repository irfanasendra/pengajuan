...
<div class="card shadow mb-4">
    <div class="p-3">
        ...
        <a href="<?=base_url('pengajuan/tolak/'.$ajuan_byid['idpengajuansurat']);?>"
            class="btn btn-danger btn-icon-split btn-sm float-right pr-3">
            <span class="icon text-white-50">
        ...
        <a href="<?=base_url('pengajuan/proses/'.$ajuan_byid['idpengajuansurat']);?>"
            class="btn btn-primary btn-icon-split btn-sm float-right pr-3">
            <span class="icon text-white-50">
            ...
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url('./assets/upload/').$row['nama_berkas'];?>" target="_blank"
